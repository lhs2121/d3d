...
call :buildProject "commonlib" "%ROOT%commonlib\commonlib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "inputlib" "%ROOT%inputlib\inputlib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "collib" "%ROOT%collib\collib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "windowlib" "%ROOT%windowlib\windowlib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "rendererlib" "%ROOT%rendererlib\rendererlib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "networklib" "%ROOT%networklib\networklib.vcxproj"
if errorlevel 1 exit /b 1

call :buildProject "game" "%ROOT%game\game.vcxproj"
if errorlevel 1 exit /b 1
